...
export const GetSystemInfo = backend.GetSystemInfo as () => Promise<
  Record<string, string>
>;
export const OpenDirectoryDialog = backend.OpenDirectoryDialog as (
  title: string,
) => Promise<string>;
export const OpenFileDialog = backend.OpenFileDialog as (
  title: string,
) => Promise<string>;
